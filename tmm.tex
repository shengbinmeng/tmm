...
\thanks{Manuscript received July 15, 2015.}
\thanks{The authors are with the Institute of Computer Science and Technology, Peking University, Beijing%
, 100080, China (Email: shengbin@pku.edu.cn, sunjun@pku.edu.cn, duanyizhou@pku.edu.cn, guozongming@pku.edu.cn; Phone: +86 1082529615; Fax: +86 1082529207). Jun Sun is the corresponding author.}}
...
\bibitem{Egilmez13}
H. E. Egilmez, S. Civanlar, and A. M. Tekalp, ``An Optimization Framework for QoS-Enabled Adaptive Video Streaming Over OpenFlow Networks'', in {\em IEEE Transactions on Multimedia}, vol. 15, no. 3, pp.710-715, 2013.
...
\bibitem{Bouten14}
N. Bouten, S. Latré, J. Famaey, W. V. Leekwijck, and F. D. Turck, ``In-Network Quality Optimization for Adaptive Video Streaming Services'', in {\em IEEE Transactions on Multimedia}, vol. 16, no. 8, pp.2281-2293, 2014.
...
\bibitem{Cicalò14}
S. Cicalò, and V. Tralli, ``Distortion-Fair Cross-Layer Resource Allocation for Scalable Video Transmission in OFDMA Wireless Networks'', in {\em IEEE Transactions on Multimedia}, vol. 16, no. 3, pp.848-863, 2014.
